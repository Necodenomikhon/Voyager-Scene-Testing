  ...
  function fitToViewport(){
    ...
    view.max = Math.max(4, fitScale * 4); // keep existing max feel, scaled
  ...
  mapRoot.addEventListener("pointerdown", (e) => {
    ...
    // Don’t pan when clicking markers/popover UI
    if (
  ...
  mapRoot.addEventListener("pointermove", (e) => {
    ...
    // If not panning yet, see if we should “promote” candidate to panning
